							...
							<head>
								...
								<!-- Header -->
									<table width="100%" height="100%" border="0" align="center" valign="middle"  cellpadding="0" cellspacing="0" style="margin:0 auto; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; border-bottom: 1px solid #000;display: block; position: absolute !important;">
										...
										{
											$headerContent .= '</td><td width="60%" align="right" style="padding:0px;font-weight: 600;"><strong>'.get_bloginfo( 'name' ).' - Contact Info</strong></td>';
										}
...
{
	$footerContent .= '<td width="600" align="left" style="padding:0px;font-weight: 600;">'.$cf7_opt_footer_text.'</td>';
}
else
{
	$footerContent .= '<td width="600" align="left" style="padding:0px;font-weight: 600;">Copyright © '.date('Y').' <a href="'.site_url().'" target="_blank">'.get_bloginfo( 'name' ).'</a></td>';	
}
$footerContent .= '<td align="right" style="padding:0px;font-weight: 600;">Page {PAGENO}</td>';
