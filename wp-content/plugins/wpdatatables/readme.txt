...
* **NEW!** Simple table - [Text documentation](https://wpdatatables.com/documentation/creating-new-wpdatatables-with-table-constructor/creating-a-simple-table-with-wpdatatables/)
...
* Line Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-line-chart)
* Column Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-column-chart)
* Pie Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-pie-chart)
* Area Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-area-chart)
* Stepped area Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-stepped-area-chart)
* Histogram - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-histogram-chart)
* Bar Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-bar-chart)
* Stacked Bar Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-stacked-bar-chart)
* Bubble Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-bubble-chart)
* Donut Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-donut-chart)
* Gauge Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-gauge-chart)
* Scatter Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-scatter-chart)
* Candlestick Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-candlestick-chart)
* Waterfall Chart - [Live example](https://wpdatatables.com/documentation/wpdatacharts/google-charts/#google-waterfall-chart)
...
1. [Report Builder](https://wpreportbuilder.com/)** - Generate Word or Excel reports from tables in your WP in 1 click
